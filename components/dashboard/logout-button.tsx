...
export function LogoutButton() {
  ...
  return (
    <button
      ...
      onClick={onLogout}
      disabled={isLoading}
      className="flex w-full items-center gap-2.5 rounded-[7px] px-3 py-2 text-[13.5px] text-text-secondary transition-colors hover:bg-surface-2 hover:text-foreground disabled:opacity-60"
    >
